# EMAIL TO SAM CILENTO — LAKOTA SOFTWARE SOLUTIONS
...
**Send to:** sales@lakotasoftware.com
**After sending:** Update `PARTNER_ACCOUNT_UPDATES.md` with date sent + note awaiting response.
