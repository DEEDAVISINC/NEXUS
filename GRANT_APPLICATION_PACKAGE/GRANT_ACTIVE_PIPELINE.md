...
- ✅ AWARDED
- ❌ DECLINED — reapply next cycle

---

## TIER 1: APPLY RIGHT NOW — THIS WEEK
*These are open today. No waiting. No excuse.*

| # | Grant | Amount | Deadline | Fee | Status | Action |
|---|---|---|---|---|---|---|
| 1 | **Amber Grant — March** | $10K + $25K annual | March 31, 2026 | $15 | 🔴 | Apply at ambergrantsforwomen.com |
| 2 | **Hello Alice Profile** | Auto-match to 30+ grants | ASAP — ongoing | FREE | 🔴 | Register + complete full profile |
| 3 | **IFundWomen Universal Grant** | $10K | Q1 cycle open now | FREE | 🔴 | Apply at ifundwomen.com/universal-grant |
| 4 | **WBENC Member Portal** | $2.5K–$50K | Rolling | FREE | 🔴 | Log in → check grants section (DDI already certified) |
| 5 | **Comcast RISE** | $25K–$100K in services | Rolling | FREE | 🔴 | Apply at comcastrise.com (BIPOC + woman-owned = perfect fit) |
| 6 | **Grants.gov Email Alert Setup** | All sizes | ASAP | FREE | 🔴 | Set saved search + enable email notifications |
...
## TIER 2: THIS MONTH (March 2026)

| # | Grant | Amount | Deadline | Fee | Status | Action |
|---|---|---|---|---|---|---|
| 11 | **Google for Startups — Women/Black Founders Fund** | $50K–$100K | Rolling | FREE | 🔴 | startup.google.com/programs |
| 12 | **Bank of America Small Business** | $5K–$25K | Rolling | FREE | 🔴 | Check via Hello Alice + bankofamerica.com |
...
## TIER 3: QUARTERLY RECURRING (Apply Every Cycle)

| Grant | Amount | Cycle | Next Due | Fee | Notes |
|---|---|---|---|---|---|
| Amber Grant | $10K monthly + $25K annual | Monthly | April 1 | $15 | Set recurring calendar — 1st of EVERY month |
| IFundWomen Universal | $10K | Quarterly | Q2 2026 | FREE | Set calendar for June 1 |
| Bank of America (multiple programs) | $5K–$25K | Multiple/year | As they open | FREE | Monitor via Hello Alice |
| JPMorgan Chase | $10K–$150K | Multiple/year | As they open | FREE | Monitor via Hello Alice |
| WBENC Member Grants | $2.5K–$50K | Rolling | Monthly check | FREE | Log in 1st of month |
...
## AWARDED
*(Build this list one by one)*

| Grant | Amount | Date Awarded | Notes |
|---|---|---|---|
| — | — | — | — |

---

## CALENDAR — RECURRING GRANT DEADLINES

| Date | Action |
|---|---|
| **March 13** | START: Hello Alice registration · Amber Grant March application |
| **March 31** | Amber Grant March deadline |
| **April 1** | Amber Grant April application (set recurring) |
| **April 1** | IFundWomen Q2 check |
| **Every Monday** | Check Nav.com/grants + Hello Alice dashboard |
| **1st of every month** | Amber Grant application ($15) + WBENC portal check |
| **Quarterly** | IFundWomen Universal Grant application |
| **Fall 2026** | InnovateHER application (SBA) |
...
*(Gather once, use everywhere)*

| Document | Status | Where |
|---|---|---|
| EIN Letter | 📋 Gather | IRS / email search 84-4114181 |
| EDWOSB/WOSB Certificate | 📋 Gather | SAM.gov download |
| WBENC Certificate | 📋 Gather | WBENC portal |
| MBE Certificate | 📋 Gather | NMSDC portal |
| Articles of Incorporation | 📋 Gather | Michigan SOS |
| 2024 Tax Return | 📋 Gather | Accountant |
| 3 Months Bank Statements | 📋 Gather | Business bank |
| P&L Statement | 📋 Gather | QuickBooks / accountant |
| W-9 | 📋 Create | irs.gov (5 min) |
| Headshot | ✅ Ready | UPLOAD_READY/Dee_Headshot.jpg |
| Logo | ✅ Ready | UPLOAD_READY/DDI_Logo_Black.png |
| WOSB Image | ✅ Ready | UPLOAD_READY/WOSB_Certification_Image.jpg |
| CWC 501c3 Letter | 📋 Gather | IRS / email search 92-3602670 |

---

*Applications going out this week. Track every submission here. Build the awarded column.*
