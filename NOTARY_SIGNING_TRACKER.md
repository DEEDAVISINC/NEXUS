...
## SIGNING COMPANY PAYMENT TERMS

### Default Rule (Most Companies)
**Most signing companies pay 30–45 days from the SIGNING DATE** unless the order page states otherwise.

**Clock starts:** Day of the signing appointment (not acceptance date).
...
| **JP Signings LLC** | **Closing date** | 30–45 days; paid 1st & 15th |
| **ASAP Pro** | **Closing date** | ~45 **business** days via Bill.com |
| **Standard Notary Services** | Signing / service date | Net 45 |
| **Signature One** | Service date | Net 45 after funds received |
...
|---|---|---|---|---|
| **First Class Signing Service** | VendorPay — batch transfers ~1st week of month, deposit ~3rd week | VendorPay | $40 - $90 | — |
| **Kriss Law / Atlantic Closing & Escrow** | VendorPay — varies, some next cycle, some 30+ days | VendorPay | $150 - $300 | — |
| **Turbo Signing** | VendorPay — ~7 days transfer, ~21 days deposit | VendorPay | $75 | — |
| **Mosaic Signing Services** | VendorPay — ~13 days transfer, ~28 days deposit | VendorPay | $60 | — |
| **Doma Title** | VendorPay — transfers ~1st week of month, deposit ~3rd week | VendorPay | $110 | — |
| **Premium Closing Solutions** | **Non-Silk:** Last week of following month (30-60 days). **Silk Title (H-######-SFB):** 75-day cycle (60-90 days) | E-check via DeluxeChecks (check portal: deluxe.com / my.echecks.com) | $80+ | 951-479-1450 / After hrs: 844-431-4833 / accounting@premiumclosingsolutions.com |
| **@SigningAgents / National Title Solutions** | **30-45 days from closing.** SBA signings: paid when title company gets paid (weekly billing cycle). | Deluxe eCheck | $125+ | 833-431-7446 / Payment issues: kevin@atsigningagents.com / DO NOT contact title company re: payments / Client: Rafael Marzo rmarzo@ntsnational.com 630-778-0007 x2037 |
| **Standard Notary Services** | **Net 45** (45 days after closing) | NotaryPay via Deluxe eCheck (email) | $100 | — |
| **Title Processing Center** | **7th of each month** for all signings completed the previous month | eCheck via email | $100+ ($40 incomplete/trip, $15 cancel after print) | 813-444-1400 / billing@titleprocessingcenter.com |
| **Premium Signature Services** | **30–45 days from signing date** (default — no terms on order page) | TBD — confirm on first payment | $75+ | 310-227-1229 / Contact: Mark Delgadillo |
...
| **Signing Solutions Group Inc** | **30–45 days from signing date** (default; mailed check — watch mailbox) | Physical check mailed to address on profile | $90+ | 949-229-3861 / 1099-NEC issued at $600+ |
...
| **Signature Xcel / Sign X** | **30–45 days from signing date** (default) | TBD — confirm on first payment | $100 | 480-530-7446 |
| **JP Signings LLC** | **30-45 days from CLOSING** (not signing date). Processed **1st and 15th** of each month. | Check (90 days to deposit; $1.50 reissue after 90 days) | $100 | 619-357-6689 / Payment: signings@jpsignings.com |
| **Sensible Signings** | **30–45 days from signing date** (default) | **ZIL Money** (watch email for payment notification / vendor setup) | TBD | — |
| **The Closing Signing Service** | **30–45 days from signing date** (default) | **Melio Payments** (watch email for Melio payment link or vendor invite) | TBD | — |
| **AZ Notary** | **30–45 days from signing date** (default) | **Melio Payments** (same as Closing Signing Service) | TBD | — |

### Melio Payments — Key Notes (The Closing Signing Service, AZ Notary)
- Payments arrive via **Melio** — watch for email from Melio with payment link or vendor onboarding
- Set up Melio account / direct deposit when prompted so future payments deposit automatically
- Track which company sent each Melio payment by order number in email subject/body

### ZIL Money — Key Notes (Sensible Signings)
- Payments arrive via **ZIL Money** — watch for ZIL payment notification email
- May require vendor setup or bank link on first payment — complete promptly

### JP Signings LLC — Key Notes
- Clock starts at **closing**, not signing appointment
- Include **picture of signer's ID** at end of signing
- **Witness required** on seller packets
- Do NOT use UPS label to Detroit for Rocket Mortgage
...
| **July 3–18** | **$100.00** | Signature Xcel (Misczak — 30–45 days from 6/3) |
| **July 5–20** | **$75.00** | Premium Signature Services (Ruci — 30–45 days from 6/5) |
...
- **@SigningAgents** Maxine Smith ($125) — inquiry sent **6/4/26** to kevin@atsigningagents.com. Follow up **6/11** if no reply.
