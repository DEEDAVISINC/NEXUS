# WORKFLOW CHECKLIST — Presolicitation
## Dry Ice with Delivery Services — G.V. Sonny Montgomery Jackson VA Medical Center
## 36C25626Q0360

**Agency:** VETERANS AFFAIRS, DEPARTMENT OF.NETWORK CONTRACT OFFICE 16
**Type:** Presolicitation
**Deadline:** 2026-02-17
**CO:** LaTonya Mack (latonya.mack@va.gov)
...
- [x] AUTO-PURSUE: Presolicitation identified — default is YES for EDWOSB-eligible
...
- [x] CO contact info populated: LaTonya Mack (latonya.mack@va.gov)

## STEP 5: SEND TO BUYER
- [x] Review cap statement (open HTML, print to PDF)
- [x] Review email text
- [x] **SENT** — February 11, 2026 at 8:48 PM EST
- [x] Sent from: info@deedavis.biz
- [x] Sent to: LaTonya.Mack@va.gov
- [x] Subject: EDWOSB Interest — Dry Ice with Delivery Services (36C25626Q0360)
- [x] Cap statement attached

## STEP 6: MONITOR FOR FULL RFP
- [ ] Watch SAM.gov for full solicitation release
- [ ] Set alert for 36C25626Q0360
