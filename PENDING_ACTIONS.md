...
| **VERTEX — HAP + Molina payer profiles DRAFTED** | Spec + JSON: `VERTEX_PAYER_PROFILES_HAP_MOLINA.md`, `VERTEX_PAYER_PROFILES.json`. Phase 6 thin design: `VERTEX_PHASE6_VOLUME_MONITOR_DESIGN.md`. **Dee review:** confirm HAP dispute/appeal days from contract; then wire profiles into scrub/837. | 🟡 **REVIEW** |
