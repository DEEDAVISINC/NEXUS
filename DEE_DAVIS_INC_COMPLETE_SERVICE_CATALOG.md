...
**Target Clients:**
- Transit agencies (bus/rail operators)
- Cities/Counties (DPW drivers, heavy equipment)
- School districts (bus drivers)
- Federal agencies (vehicle operators)
- Trucking companies
- Construction companies

**Services:**
- DOT-compliant urine drug testing
...
- Healthcare facilities (staff credentialing)
...
- Contractors (workforce verification)
- School districts
...
### **DNA Testing** 🧬
**Target Clients:**
- Courts (paternity cases)
- Law enforcement (forensics)
- Immigration (relationship verification)
- Private clients (ancestry/health)
...
**Target Clients:**
- Large employers (on-site convenience)
- Remote job sites (construction, oil/gas)
- Events (health screenings)
- Rural areas (limited access to testing)
...
**Pricing Model:**
- Base fee: $200-$500 (travel/setup)
- Per-person testing: Standard rates
- Multi-day contracts available

**NAICS Codes:** 621999, 541990
...
### **Surety Bonds** 🛡️
**Target Clients:**
- Government contractors (bid/performance bonds)
- Licensed professionals (license bonds)
- Court requirements (fiduciary bonds)
...
**Partnership:** SuretyCloud

**Pricing Model:**
- Bond premium: 1-3% of bond amount
- Small bonds (<$25K): Flat fee $100-$500
- Placement fee: $50-$200

**NAICS Codes:** 524126, 524210
...
- CMS Connect/PECOS credentialing
...
- Ongoing management: % of revenue

**NAICS Codes:** 541611, 621910
...
- CHAMPS system navigation
- CMS documentation
- Provider number acquisition

**Pricing Model:**
- Per enrollment: $500-$2,000
- Multi-state packages available
...
**Pricing Model:**
- Consulting: $150-$300/hour
- Performance-based: % of cost savings

**NAICS Codes:** 541614, 541618
...
**Target Clients:**
- Government agencies (office moves)
- Military (household goods)
- Universities (student moves)
...
### **Event Services** 🎪
**Target Clients:**
- Government agencies (public events)
- Cities (festivals, ceremonies)
- Schools (ceremonies, sports)
...
### **Crisis Coordination & Emergency Logistics** 🚨
**Target Clients:**
...
- ATLAS PM crisis management

**Pricing Model:**
- Emergency rate: $1,000-$2,000/day
...
**This is the complete DEE DAVIS INC service portfolio integrated into NEXUS.** ✅
