...
## Priority 2 — CBP Medical Support 70B06C26R00000017 (DUE THU APR 10)

- Folder: `BIDS:RESOURCES/DHS CBP MEDICAL SUPPORT SERVICES/`
- ProposalBio gate unlocked — finish pricing + personnel gaps per checklist
- Action: Phase I submission on track for Thursday
...
| DIBBS verification email | dibbs_validation@dla.mil |
| Lakota / Sam Cilento call | WHORL, EDO, ATF EFT — update `FINGERPRINTING_CURRENT_STATUS.md` after |
| MiLogin MDHHS | davisd122 — sign in so account stays active |
| NAICS 488190 on SAM.gov | Freight 1st Direct / AOG lane |

---

## Aging follow-ups (March 26)

- Larry Smith, ModivCare NEMT
- Angelica, Molina NEMT routing
...
| Apr 10 | CBP Medical Phase I; Harris Health RFO |
...
*Updated: good night — April 6, 2026.*
