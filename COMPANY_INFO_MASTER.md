...
- **Employee/Vendor Numbers (GATEWAY, Jul 2026):** every hire gets a sequential personnel number at the moment onboarding starts — `DDI-EMP-####` for W-2 employees, `DDI-VEN-####` for 1099 contractors ("vendor number," Dee's terminology).
