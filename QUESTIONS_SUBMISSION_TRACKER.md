# QUESTIONS SUBMISSION TRACKER

**Source of truth for CO/buyer written questions.**  
When questions are submitted, update **this file** and the bid folder `WORKFLOW_CHECKLIST.md` the same session.
...
| **26ITB1580280B** | Fulton County Drug Testing | Mar 25, 2026 | **Mar 5, 2026** | BidNet | — | `BIDS:RESOURCES/FULTON COUNTY DRUG TESTING - CANCELLED/` |
| **RFP 128 2600000415** | Kentucky DMS Mine Drug Testing | Apr 23, 2026 | **Apr 23, 2026 (early)** | Email | Robin.Uphoff@ky.gov | `BIDS:RESOURCES/KENTUCKY DMS MINE DRUG TESTING/` |
| **THVC RFP** | Kentucky THVC Drug Testing | Mar 9, 2026 | **Feb 25, 2026** | Email | — | `BIDS:RESOURCES/KENTUCKY THVC DRUG TESTING/` |

---

## ⬜ NOT YET SUBMITTED — ACTIVE
...
## ❌ NO QUESTION PERIOD / CLOSED

| Solicitation | Notes |
|---|---|
| DRPA Occ Health RFP | Ariba — check portal for Q&A if enabled |
| CCRTA Occ Medical | PlanetBids — verify if Q&A posted |
| Pasco-Pinellas AAA Transport | Download RFP — check for Q&A deadline |

---

## SYNC CHECKLIST (after every question submission)

1. [ ] Mark step ✅ in bid folder `WORKFLOW_CHECKLIST.md`
2. [ ] Add row to **SUBMITTED** table above
3. [ ] Update `BID_TRACKER_DASHBOARD.md` row — remove "questions due" or mark ✅ submitted
4. [ ] Strike/update matching line in `calendars/SCHEDULED_AGENDA.md`
5. [ ] Remove from `TODAY_AGENDA.md` / `PENDING_ACTIONS.md` if listed as due

---

*Bid folder checklist + this tracker = truth. Dashboard and calendar follow.*
