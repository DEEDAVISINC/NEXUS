          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <div className="text-right hidden sm:block">
                ...
                <div className="text-sm font-bold text-white">Cause We Care + Dee Davis Inc</div>
      ...
      <div className="rounded-xl border p-6" style={{ backgroundColor: CARD_BG, borderColor: BORDER_CLR }}>
        <div className="text-center mb-6">
          ...
          <div className="text-xs mt-1" style={{ color: MDHHS_TEAL }}>
            Operated by Cause We Care Foundation + Dee Davis Inc · {reportPeriod}
          </div>
        </div>
        ...
        <div className="border-t pt-4 text-center" style={{ borderColor: BORDER_CLR }}>
          <div className="text-[10px]" style={{ color: MUTED }}>
            ...
            and Dee Davis Inc, in partnership with the Michigan Department of Health & Human Services.
          </div>
