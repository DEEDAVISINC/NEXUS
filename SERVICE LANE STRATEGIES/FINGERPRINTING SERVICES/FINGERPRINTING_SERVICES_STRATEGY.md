# FINGERPRINTING / LIVE SCAN SERVICES — Bid Strategy

**Category:** Service Brokering (EDWOSB Prime + Subcontractor)
**Business Model:** Win contract as EDWOSB prime, subcontract to licensed Live Scan provider
**NAICS Codes:** 561611 (Investigation Services), 561612 (Security Guards and Patrol Services)

---

## WHY THIS IS A GREAT FIT

- **EDWOSB prime contractor model** — you hold the contract, sub does the fingerprinting
- **Low overhead** — no equipment, no storefront, no special training needed
- **Recurring revenue** — agencies always need fingerprinting (new hires, licensing, background checks)
- **Multiple subcontractor options in Metro Detroit** — proven providers ready to partner
- **Growing demand** — more states requiring fingerprint-based background checks for teachers, healthcare workers, childcare providers

## HOW THE SERVICE BROKERING MODEL WORKS

```
Agency (Client) ──→ Dee Davis Inc. (EDWOSB Prime) ──→ Fingerprinting Vendor (Sub)
     ↑                      ↑                              ↑
   Pays contract price    Takes 15-25% margin         Does the actual work
   Gets EDWOSB credit     Manages relationship         Gets steady business
```

**Your value to the agency:** EDWOSB certification (they get diversity credit), single point of contact, contract management
**Your value to the sub:** You bring them government contracts they can't win on their own (no EDWOSB cert)

## POTENTIAL SUBCONTRACTORS (Metro Detroit)

### A-J's Livescan Fingerprinting and Notary Services
- **Location:** Farmington Hills, MI
- **Phone:** 248-996-7499
- **Website:** ajsmobileservices.com
- **Services:** Live Scan fingerprinting, mobile services
- **Pricing:** $85/scan + $2/mile for mobile
- **Authorized by:** Michigan State Police, FBI
- **Also offers:** Notary services (synergy with your notary work)
- **SUBCONTRACTOR FIT: EXCELLENT** — local, mobile, authorized

### Certifix Livescan (UPS Store locations)
- **Phone:** 800-701-5788
- **Locations:**
  - 269 Walker St., Detroit, MI 48207
  - 29203 Plymouth Rd, Livonia, MI 48150
- **Note:** Franchise model — may not be open to subcontracting

### IdentoGO (IDEMIA)
- **Website:** identogo.com/locations/michigan
- **Note:** Large national provider, FBI Channeling Agent
- **Subcontractor fit:** Possible but they're big — may want to be prime themselves

### Michigan State Police Approved Vendors
- **Contact for vendor list:** MSPLivescan@michigan.gov or 517-241-0606 Option 3
- **Website:** michigan.gov/msp/services/live-scan-vendors

## ACTIVE OPPORTUNITIES FOUND

1. **E-RFQ 26-036 — Livescan Fingerprinting Services** (InstantMarkets)
   - Status: Need to identify issuing agency and deadline
   - Action: Search procurement portals for this RFQ number

2. **Fingerprinting Services** (#12 on InstantMarkets)
   - Generic listing — need to pull actual solicitation

3. **RFP 1139 — Exam Development, Delivery, and Fingerprint Collection**
   - Combined service (exam + fingerprinting)
   - Could be a fit if we partner with testing vendor too

## DIVERSITY ADVANTAGE
- [x] EDWOSB advantage: STRONG — agencies need diversity credit
- [x] Small business set-aside: Common for fingerprinting services
- [ ] Local vendor preference: CHECK per solicitation
- [x] Best value evaluation: Diversity often tips these

## PRICING MODEL

| Service | Sub Cost | Your Price | Your Margin |
|---------|----------|------------|-------------|
| Standard Live Scan (in-office) | $65-$85 | $95-$120 | $30-$35 (26-35%) |
| Mobile Live Scan (on-site) | $100-$130 | $150-$185 | $50-$55 (27-35%) |
| Bulk Rate (50+ scans/month) | $55-$70/ea | $85-$100/ea | $30/ea (30-35%) |
| Rush/After-Hours | $120-$150 | $175-$225 | $55-$75 (31-33%) |

## IMMEDIATE NEXT STEPS

1. **Call A-J's Livescan** (248-996-7499) — Discuss partnership/subcontracting
   - "Hi, calling from Dee Davis Inc. We're an EDWOSB that wins government contracts for professional services. We're looking for a licensed Live Scan provider to partner with on government fingerprinting contracts in Michigan. Would you be interested in discussing a subcontracting arrangement?"
   - Ask about: their capacity, pricing for volume, willingness to work under your contract
2. **Search SAM.gov** — NAICS 561611, WOSB/EDWOSB set-aside, fingerprinting
3. **Contact Michigan State Police** — Ask about becoming an approved Live Scan vendor list participant (even as a broker)
4. **Track down E-RFQ 26-036** — Search state/local procurement portals
5. **Draft subcontractor agreement template** — Standard terms for fingerprinting subs

## PROFIT MODEL

**Example: County Government Contract (Annual)**
- 200 employees/new hires per year, each needing fingerprinting
- Sub cost: 200 x $75 = $15,000
- Contract price: 200 x $110 = $22,000
- **Gross Profit: $7,000 (32% margin)**

**Example: School District Contract (Annual)**
- 500 teachers/staff requiring background checks
- Sub cost: 500 x $70 = $35,000
- Contract price: 500 x $100 = $50,000
- **Gross Profit: $15,000 (30% margin)**

## IMPORTANT NOTE

You already have **Federal Compliance & Credentialing** as a listed service line on deedavis.biz. This includes mobile testing programs, background checks, and DOT compliance. Fingerprinting fits naturally into this existing service line.

**What you need to bid:**
- EDWOSB certification (you have it)
- SAM.gov registration (you have it — CAGE 8UMX3)
- A licensed subcontractor (A-J's or similar)
- A subcontracting agreement
- Insurance (your existing business insurance)

**Bundle opportunity:** Fingerprinting + Quest Diagnostics drug testing + background checks (Turn.ai) = complete Federal Compliance & Credentialing package under one contract.
